...
import '../../domain/usecases/add_list_accounts_operations_usecase.dart';
import '../../domain/usecases/delete_account_operation_usecase.dart';
import '../../domain/usecases/get_account_operation_for_customer_usecase.dart';
...
import '../../domain/entities/mid_account_entity.dart';
import '../../domain/entities/ref_account_entity.dart';
import '../../domain/usecases/add_account_usecase.dart';
import '../../domain/usecases/get_all_accounts_operation_usecase.dart';
  ...
  Future<void> addExchangeOperation(
    ...
    final operations = [
      AccountsOperationsEntity(
        ...
        operationStatement: description,
        operationType: type,
      ),
      AccountsOperationsEntity(
